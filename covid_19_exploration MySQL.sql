-- THIS QUERY IS USED FOR MYSQL DATABASE.
...
SELECT * From covid_19.covid_deaths;

SELECT * FROM covid_19.covid_vaccinations;
...
-- Showing the highest death count in a country(populatio)
SELECT location, population,
